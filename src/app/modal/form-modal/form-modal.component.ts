...
import { FormUnifiedComponent } from '../../form-unified/form-unified.component';
...
export class FormModalComponent implements OnInit, OnDestroy {
  ...
  // Modifiez la méthode onNextStep
  onNextStep(formData: any) {
    this.formModalService.nextStep(this.currentStep, formData);
  }
